...
export default function Profile() {
  ...
  if (!user) {
    return (
      <div className="min-h-screen w-full bg-dark flex items-center justify-center">
        <p className="min-h-screen w-full bg-dark loader text-t-light"></p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen w-full bg-dark">
      <main className="w-full xl:w-[60%] m-auto flex flex-col justify-center items-center gap-4 p-10">
        <div className="w-full border-2 rounded-2xl border-t-light p-4 my-4 flex flex-col gap-2">
          ...
          <Link
            to="/add/post"
            className="text-t-light flex items-center w-max bg-main/30 border-2 border-main/30 p-2 pb-3.5 rounded-xl"
          >
